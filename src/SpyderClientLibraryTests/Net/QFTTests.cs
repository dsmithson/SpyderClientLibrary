    ...
    public class QFTTests
    {
        ...
        public async Task GetDirectories()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < expected.Length; i++)
                    expected[i] = new DirectoryInfo(expected[i]).Name;
        ...
        public async Task GetFiles()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < expected.Length; i++)
                    expected[i] = Path.GetFileName(expected[i]);
        ...
        public async Task FileSendTime()
        {
            ...
            try
            {
                ...
                Console.WriteLine("SendingB {0}MB file completed in {1} ({2}k/s", megabytes, span, (fileSize / 1024f) / (float)span.TotalSeconds);
        ...
        public async Task FileReceiveTime()
        {
            ...
            try
            {
                ...
                DateTime endTime = DateTime.Now;
                TimeSpan span = endTime.Subtract(startTime);
                Console.WriteLine("Receiving {0}MB file completed in {1} ({2}k/s", megabytes, span, (fileSize / 1024f) / (float)span.TotalSeconds);
